...
namespace AmourConnect.Infra.Persistence
{
    internal class AmourConnectDbContext(DbContextOptions<AmourConnectDbContext> options) : DbContext(options), IAmourConnectDbContext
    {
