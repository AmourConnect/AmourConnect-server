...
export function corps_inscription_temporaire(pseudo_xss: any, tokenVerifEmail: any) {
    ...
    <body>\
      <div class=\'container\'>\
        <p class=\'header\'>Salut ' + pseudo_xss + ' 😎</p>\
  ...
  export function corps_inscription_validation(pseudo: string) {
